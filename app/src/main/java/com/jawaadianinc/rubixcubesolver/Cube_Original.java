...
public class Cube_Original {

    //Stores the state of the cubeOriginal as an object of 26 cubies
    private final com.jawaadianinc.rubixcubesolver.Cubie[][][] cubiePos = new com.jawaadianinc.rubixcubesolver.Cubie[3][3][3];

    public Cube_Original() {
        //Up, Front Row
        cubiePos[0][0][0] = new com.jawaadianinc.rubixcubesolver.Cubie(0, 0, 0,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('Y', 'U'), new com.jawaadianinc.rubixcubesolver.CubieColor('R', 'L'), new com.jawaadianinc.rubixcubesolver.CubieColor('G', 'F')}, true, false);
        cubiePos[1][0][0] = new com.jawaadianinc.rubixcubesolver.Cubie(1, 0, 0,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('Y', 'U'), new com.jawaadianinc.rubixcubesolver.CubieColor('G', 'F')}, false, true);
        cubiePos[2][0][0] = new com.jawaadianinc.rubixcubesolver.Cubie(2, 0, 0,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('Y', 'U'), new com.jawaadianinc.rubixcubesolver.CubieColor('G', 'F'), new com.jawaadianinc.rubixcubesolver.CubieColor('O', 'R')}, true, false);

        //Front, E Row
        cubiePos[0][0][1] = new com.jawaadianinc.rubixcubesolver.Cubie(0, 0, 1,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('R', 'L'), new com.jawaadianinc.rubixcubesolver.CubieColor('G', 'F')}, false, true);
        cubiePos[1][0][1] = new com.jawaadianinc.rubixcubesolver.Cubie(1, 0, 1,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('G', 'F')}, false, false);
        cubiePos[2][0][1] = new com.jawaadianinc.rubixcubesolver.Cubie(2, 0, 1,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('G', 'F'), new com.jawaadianinc.rubixcubesolver.CubieColor('O', 'R')}, false, true);

        //Down, Front Row
        cubiePos[0][0][2] = new com.jawaadianinc.rubixcubesolver.Cubie(0, 0, 2,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('W', 'D'), new com.jawaadianinc.rubixcubesolver.CubieColor('R', 'L'), new com.jawaadianinc.rubixcubesolver.CubieColor('G', 'F')}, true, false);
        cubiePos[1][0][2] = new com.jawaadianinc.rubixcubesolver.Cubie(1, 0, 2,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('W', 'D'), new com.jawaadianinc.rubixcubesolver.CubieColor('G', 'F')}, false, true);
        cubiePos[2][0][2] = new com.jawaadianinc.rubixcubesolver.Cubie(2, 0, 2,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('W', 'D'), new com.jawaadianinc.rubixcubesolver.CubieColor('G', 'F'), new com.jawaadianinc.rubixcubesolver.CubieColor('O', 'R')}, true, false);

        //Up, S Row
        cubiePos[0][1][0] = new com.jawaadianinc.rubixcubesolver.Cubie(0, 1, 0,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('R', 'L'), new com.jawaadianinc.rubixcubesolver.CubieColor('Y', 'U')}, false, true);
        cubiePos[1][1][0] = new com.jawaadianinc.rubixcubesolver.Cubie(1, 1, 0,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('Y', 'U')}, false, false);
        cubiePos[2][1][0] = new com.jawaadianinc.rubixcubesolver.Cubie(2, 1, 0,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('Y', 'U'), new com.jawaadianinc.rubixcubesolver.CubieColor('O', 'R')}, false, true);

        //E, S Row
        cubiePos[0][1][1] = new com.jawaadianinc.rubixcubesolver.Cubie(0, 1, 1,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('R', 'L')}, false, false);
        cubiePos[1][1][1] = new com.jawaadianinc.rubixcubesolver.Cubie(1, 1, 1,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('A', 'A')}, //Just giving random, non-legitimate values for color and direction
                false, false);
        cubiePos[2][1][1] = new com.jawaadianinc.rubixcubesolver.Cubie(2, 1, 1,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('O', 'R')}, false, false);

        //Down, S Row
        cubiePos[0][1][2] = new com.jawaadianinc.rubixcubesolver.Cubie(0, 1, 2,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('R', 'L'), new com.jawaadianinc.rubixcubesolver.CubieColor('W', 'D')}, false, true);
        cubiePos[1][1][2] = new com.jawaadianinc.rubixcubesolver.Cubie(1, 1, 2,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('W', 'D')}, false, false);
        cubiePos[2][1][2] = new com.jawaadianinc.rubixcubesolver.Cubie(2, 1, 2,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('W', 'D'), new com.jawaadianinc.rubixcubesolver.CubieColor('O', 'R')}, false, true);

        //Up, Back Row
        cubiePos[0][2][0] = new com.jawaadianinc.rubixcubesolver.Cubie(0, 2, 0,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('Y', 'U'), new com.jawaadianinc.rubixcubesolver.CubieColor('R', 'L'), new com.jawaadianinc.rubixcubesolver.CubieColor('B', 'B')}, true, false);
        cubiePos[1][2][0] = new com.jawaadianinc.rubixcubesolver.Cubie(1, 2, 0,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('Y', 'U'), new com.jawaadianinc.rubixcubesolver.CubieColor('B', 'B')}, false, true);
        cubiePos[2][2][0] = new com.jawaadianinc.rubixcubesolver.Cubie(2, 2, 0,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('Y', 'U'), new com.jawaadianinc.rubixcubesolver.CubieColor('B', 'B'), new com.jawaadianinc.rubixcubesolver.CubieColor('O', 'R')}, true, false);

        //E, Back Row
        cubiePos[0][2][1] = new com.jawaadianinc.rubixcubesolver.Cubie(0, 2, 1,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('R', 'L'), new com.jawaadianinc.rubixcubesolver.CubieColor('B', 'B')}, false, true);
        cubiePos[1][2][1] = new com.jawaadianinc.rubixcubesolver.Cubie(1, 2, 1,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('B', 'B')}, false, false);
        cubiePos[2][2][1] = new com.jawaadianinc.rubixcubesolver.Cubie(2, 2, 1,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('B', 'B'), new com.jawaadianinc.rubixcubesolver.CubieColor('O', 'R')}, false, true);

        //Down, Back Row
        cubiePos[0][2][2] = new com.jawaadianinc.rubixcubesolver.Cubie(0, 2, 2,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('W', 'D'), new com.jawaadianinc.rubixcubesolver.CubieColor('R', 'L'), new com.jawaadianinc.rubixcubesolver.CubieColor('B', 'B')}, true, false);
        cubiePos[1][2][2] = new com.jawaadianinc.rubixcubesolver.Cubie(1, 2, 2,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('W', 'D'), new com.jawaadianinc.rubixcubesolver.CubieColor('B', 'B')}, false, true);
        cubiePos[2][2][2] = new com.jawaadianinc.rubixcubesolver.Cubie(2, 2, 2,
                new com.jawaadianinc.rubixcubesolver.CubieColor[]{new com.jawaadianinc.rubixcubesolver.CubieColor('W', 'D'), new com.jawaadianinc.rubixcubesolver.CubieColor('B', 'B'), new com.jawaadianinc.rubixcubesolver.CubieColor('O', 'R')}, true, false);

    }

    public static boolean isSolvable(char[][][] colors) {
        //checking if all colors show exactly 9x
        ...
        //checks whether each color occurs 9 times
        for (int times : timesInputted) {
            if (times != 9) return false;
        }

        //check if any cubie contains the SAME COLORS more than once
        Cube_Original cubeOriginal = new Cube_Original();
        cubeOriginal.setAllColors(colors);

        for (com.jawaadianinc.rubixcubesolver.Cubie[][] i : cubeOriginal.cubiePos) {
            for (com.jawaadianinc.rubixcubesolver.Cubie[] j : i) {
                for (com.jawaadianinc.rubixcubesolver.Cubie cubie : j) {
                    com.jawaadianinc.rubixcubesolver.CubieColor[] tempColors = cubie.getColors();
                    List<Character> tempList = new ArrayList<>();
                    for (com.jawaadianinc.rubixcubesolver.CubieColor color : tempColors) {
                    ...
                    for (int k = 0; k < tempList.size() && k < 2; k++) {
                        ...
                        //the cubeOriginal is unsolvable
        ...
        cubeOriginal.insertAllEdges();

        //check the EDGE ORIENTATIONS
        int oriented = 0;
        for (int x = 0; x < 3; x++) {
            for (int y = 0; y < 3; y++) {
                if (cubeOriginal.cubiePos[x][y][0].isEdgeCubie() &&
                        cubeOriginal.cubiePos[x][y][0].getDirOfColor('Y') == 'U')
                    oriented++;
            }
        }
        ...
        int twists = 0;
        for (int i = 0; i < 4; i++) {
            char dir = cubeOriginal.cubiePos[0][0][0].getDirOfColor('Y');
            if (dir == 'L')
                twists++;
            else if (dir == 'F')
                twists += 2;
        ...
        //If the total number of twsits isn't divislbe by 3, cubeOriginal is unsolvable
        return twists % 3 == 0;
    }
    ...
    public void turn(String turn) {
        char[] preChange;
        char[] postChange;
        com.jawaadianinc.rubixcubesolver.Cubie[][] matrix = new com.jawaadianinc.rubixcubesolver.Cubie[3][3]; //matrix to be rotated
        ...
        switch (turn) {
            case "B":
                ...
                //Reset the actual cubeOriginal's cubies to those of the rotated matrix
                for (int i = 0; i < 3; i++) {
                    for (int j = 0; j < 3; j++) {
     ...
     */
    private com.jawaadianinc.rubixcubesolver.Cubie[][] rotateMatrix(com.jawaadianinc.rubixcubesolver.Cubie[][] orig, int degrees, char[] preChange,
                                                                    char[] postChange) {
        com.jawaadianinc.rubixcubesolver.Cubie[][] rotated = new com.jawaadianinc.rubixcubesolver.Cubie[3][3];
        if (degrees == 90) {
            ...
            for (int i = 0; i < 3; i++) {
                for (int j = 0; j < rotated[0].length / 2; j++) {
                    com.jawaadianinc.rubixcubesolver.Cubie tempCubie = rotated[i][3 - j - 1];
            ...
            for (int i = 0; i < rotated[0].length / 2; i++) {
                for (int j = 0; j < 3; j++) {
                    com.jawaadianinc.rubixcubesolver.Cubie tempCubie = rotated[3 - i - 1][j];
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                com.jawaadianinc.rubixcubesolver.CubieColor[] tempColors = rotated[i][j].getColors();
                for (com.jawaadianinc.rubixcubesolver.CubieColor tempColor : tempColors) {
                    int index = 6;
    ...
    /**
     * Loops through the characters in a String of standard turning notation to apply the set of moves to the cubeOriginal
     * Checks for clockwise, double, and counterclockwise turns
     *
     * @param moves the moves to be applied to the cubeOriginal
     * @return the moves performed on the cubeOriginal (same as {@code moves})
     */
     ...
     * the moves "U" will be applied upon the cubeOriginal to negate the "U' ". Helper method for use in the
    ...
    /**
     * Scrambles a cubeOriginal according to WCA rules (White on top, Green in front).
     * After scrambling, returns the cubeOriginal to the original position (Yellow on top, Green in front) form
     * which a solution can be generated.
     *
     * @param scramble the scramble to be performed
     */
    public Cube_Original scramble(String scramble) {
        //Rotate the cubeOriginal to get white on top, then return cubeOriginal to original position at end of scramble
            ...
            for (int i = 0; i < 3; i++) {
                for (int j = 0; j < 3; j++) {
                    if (cubiePos[i][j][0].isEdgeCubie()) {
                        com.jawaadianinc.rubixcubesolver.CubieColor[] tempColors = cubiePos[i][j][0].getColors();
            ...
            for (int i = 0; i < 3; i++) {
                for (int j = 0; j < 3; j++) {
                    if (cubiePos[i][j][1].isEdgeCubie()) {
                        com.jawaadianinc.rubixcubesolver.CubieColor[] tempColors = cubiePos[i][j][1].getColors();
                        for (int k = 0; k < 2; k++) {
    ...
    private String prepareSlot(int x, int y, int z, char color) {
        int numUTurns = 0;
        com.jawaadianinc.rubixcubesolver.CubieColor[] tempColor = cubiePos[x][y][z].getColors();
    ...
    public String permuteLastLayer() {
        ...
        int numHeadlights = 0;
        for (int i = 0; i < 4; i++) {
            turn("y"); //Since we are rotating 4 times, the cubeOriginal is unaffected in the end
        ...
        //Adjust the U layer to finish the cubeOriginal!
    ...
    /**
     * This method allows for the painting of the cubeOriginal in the GUI.
     ...
     *
     * @return the set of all colors that define the state of the cubeOriginal
     */
    public char[][][] getColors() {
        ...
        //This means, for example, that the left side of the cubeOriginal will be rotated 90 degrees clockwise such that
    ...
    /**
     * Outputs the position, colors, and respective directions of colors of every cubie making up the cubeOriginal.
        ...
        for (int i = 0; i < cubiePos.length; i++) {
            for (int j = 0; j < cubiePos[0].length; j++) {
                for (int k = 0; k < cubiePos[0][0].length; k++) {
                    com.jawaadianinc.rubixcubesolver.CubieColor[] tempColor = cubiePos[i][j][k].getColors();
                    Log.e("" + i + ", " + j + ", " + k + ", ", "" + k);
                    for (com.jawaadianinc.rubixcubesolver.CubieColor aTempColor : tempColor) {
    ...
    /**
     * Sets all the colors of the cubeOriginal to the colors inputed by the user during color selection mode.
     ...
     *
     * @param colors all colors to be put into the cubeOriginal
     */
