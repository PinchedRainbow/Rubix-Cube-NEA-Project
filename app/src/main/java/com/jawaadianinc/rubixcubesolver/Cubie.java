...
public class Cubie {
     ...
     */
    public Cubie(int xPos, int yPos, int zPos, com.jawaadianinc.rubixcubesolver.CubieColor[] nColors, boolean isCorner,
                 boolean isEdge) {
        x = xPos;
        y = yPos;
        z = zPos;
     ...
     */
    public com.jawaadianinc.rubixcubesolver.CubieColor[] getColors() {
        return colors;
    }
     ...
     */
    public void setColors(com.jawaadianinc.rubixcubesolver.CubieColor[] newColors) {
