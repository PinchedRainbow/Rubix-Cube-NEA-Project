...
public class Tools {
    ...
    /**
     * Convert a scramble string to its cubeOriginal definition string.
     *
     * @param s scramble string. Only outer moves (U, R, F, D, L, B, U2, R2, ...) are recognized.
     * @return cubeOriginal definition string, which represent the state generated by the scramble<br>
     */
    ...
    /**
     * Check whether the cubeOriginal definition string s represents a solvable cubeOriginal.
     *
     * @param facelets is the cubeOriginal definition string , see {@link cs.min2phase.Search#solution(String facelets, int maxDepth, long timeOut, long timeMin, int verbose)}
     * @return 0: Cube_Original is solvable<br>
